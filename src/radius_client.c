...
radius_req_t *
acquire_req(radius_server_t* rs, ngx_log_t *log)
{
...
void
release_req(radius_req_t *req, ngx_log_t *log)
{
                    ...
                    ngx_log_t *log)
{
    ...
    if (prev_req == NULL) {
        ...
        //release_req(prev_req, log); // TODO
    }

    radius_req_t *req = acquire_req(rs, log);
    if (req == NULL) {
